...
微信支付个人版,免认证,免备案,免提现,WordPress WooCommerce立即接入微信收款

== Description ==

此插件适合无法开通微信支付的个人用户使用,免签约免备案免认证，仅限个人用户使用。企业用户请购买企业版：<a href="https://www.wpweixin.net/product/201.html" target="_blank">WordPress WooCommerce微信支付插件红包版</a>
...
* 支持微信H5支付（开发中即将发布）
* 支持管理员微信订单消息通知
* 平台代收款，需提现。如需免签约免提现，请使用<a href="https://www.xunhupay.com" target="_blank">虎皮椒</a>
